...
InfoPublisher::InfoPublisher() : mp_participant(nullptr), mp_publisher(nullptr) {}

InfoPublisher::~InfoPublisher() { Domain::removeParticipant(mp_participant); }

bool InfoPublisher::init() {
...
void InfoPublisher::PubListener::onPublicationMatched(Publisher *pub, MatchingInfo &info) {
    (void) pub;
...
void InfoPublisher::run() {
    ...
    st.sender_info().name() = mp_participant->getAttributes().rtps.getName();
