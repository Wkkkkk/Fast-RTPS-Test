...
#ifndef _BASE_PUBSUBTYPES_H_
#define _BASE_PUBSUBTYPES_H_
...
#error Generated Base is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
