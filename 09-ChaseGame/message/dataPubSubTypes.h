...
#ifndef _DATA_PUBSUBTYPES_H_
#define _DATA_PUBSUBTYPES_H_
...
#error Generated data is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type Vec3 defined by the user in the IDL file.
 * @ingroup DATA
 */
class Vec3PubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef Vec3 type;

    Vec3PubSubType();

    virtual ~Vec3PubSubType();
 ...
 * @ingroup DATA
 */
class TargetPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef Target type;

    TargetPubSubType();

    virtual ~TargetPubSubType();
