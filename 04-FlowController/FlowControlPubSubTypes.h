...
#ifndef _FLOWCONTROL_PUBSUBTYPES_H_
#define _FLOWCONTROL_PUBSUBTYPES_H_
...
#error Generated FlowControl is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup FLOWCONTROL
 */
class FlowControlPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef FlowControl type;

    FlowControlPubSubType();

    virtual ~FlowControlPubSubType();
...
#endif // _FLOWCONTROL_PUBSUBTYPES_H_