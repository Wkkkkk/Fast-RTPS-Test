...
public:
     ...
     */
    eProsima_user_DllExport FlowControl(const FlowControl &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object FlowControl that will be copied.
     */
    eProsima_user_DllExport FlowControl(FlowControl &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object FlowControl that will be copied.
     */
    eProsima_user_DllExport FlowControl &operator=(const FlowControl &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object FlowControl that will be copied.
     */
    eProsima_user_DllExport FlowControl &operator=(FlowControl &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const FlowControl &data, size_t current_alignment = 0);
