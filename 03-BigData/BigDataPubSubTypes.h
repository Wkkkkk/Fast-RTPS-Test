...
#ifndef _BIGDATA_PUBSUBTYPES_H_
#define _BIGDATA_PUBSUBTYPES_H_
...
#error Generated BigData is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
 ...
 * @ingroup BIGDATA
 */
class BigDataPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef BigData type;

    BigDataPubSubType();

    virtual ~BigDataPubSubType();
