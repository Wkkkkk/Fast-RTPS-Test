...
mPointArray::mPointArray(const mPointArray &x) {
    m_id = x.m_id;
    m_points = x.m_points;
}

mPointArray::mPointArray(mPointArray &&x) {
    m_id = x.m_id;
    m_points = std::move(x.m_points);
}

mPointArray &mPointArray::operator=(const mPointArray &x) {
    m_id = x.m_id;
    m_points = x.m_points;
...
mPointArray &mPointArray::operator=(mPointArray &&x) {
    m_id = x.m_id;
    m_points = std::move(x.m_points);
...
size_t mPointArray::getMaxCdrSerializedSize(size_t current_alignment) {
...
size_t mPointArray::getCdrSerializedSize(const mPointArray &data, size_t current_alignment) {
    (void) data;
    size_t initial_alignment = current_alignment;
...
void mPointArray::serialize(eprosima::fastcdr::Cdr &scdr) const {
    scdr << m_id;
    scdr << m_points;
}

void mPointArray::deserialize(eprosima::fastcdr::Cdr &dcdr) {
    dcdr >> m_id;
    dcdr >> m_points;
}

size_t mPointArray::getKeyMaxCdrSerializedSize(size_t current_alignment) {
...
bool mPointArray::isKeyDefined() {
    return false;
}

void mPointArray::serializeKey(eprosima::fastcdr::Cdr &scdr) const {
    (void) scdr;


}

mLineArray::mLineArray() {
    m_id = 0;
...
mLineArray::mLineArray(const mLineArray &x) {
    m_id = x.m_id;
    m_points = x.m_points;
}

mLineArray::mLineArray(mLineArray &&x) {
    m_id = x.m_id;
    m_points = std::move(x.m_points);
}

mLineArray &mLineArray::operator=(const mLineArray &x) {
    m_id = x.m_id;
    m_points = x.m_points;
...
mLineArray &mLineArray::operator=(mLineArray &&x) {
    m_id = x.m_id;
    m_points = std::move(x.m_points);
...
size_t mLineArray::getMaxCdrSerializedSize(size_t current_alignment) {
    size_t initial_alignment = current_alignment;
...
size_t mLineArray::getCdrSerializedSize(const mLineArray &data, size_t current_alignment) {
    (void) data;
    size_t initial_alignment = current_alignment;
...
void mLineArray::serialize(eprosima::fastcdr::Cdr &scdr) const {
    scdr << m_id;
    scdr << m_points;
}

void mLineArray::deserialize(eprosima::fastcdr::Cdr &dcdr) {
    dcdr >> m_id;
    dcdr >> m_points;
}

size_t mLineArray::getKeyMaxCdrSerializedSize(size_t current_alignment) {
    size_t current_align = current_alignment;
...
bool mLineArray::isKeyDefined() {
    return false;
}

void mLineArray::serializeKey(eprosima::fastcdr::Cdr &scdr) const {
    (void) scdr;
